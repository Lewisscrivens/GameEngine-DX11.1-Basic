...
int InputClass::GetMouseXChange()
{
...
int InputClass::GetMouseYChange()
{
...
void InputClass::ResetMousePosition()
{
...
{
	// Do a bitwise and on the keyboard state to check if H is currently being pressed.
...
bool InputClass::IsLeftShiftPressed()
{
	// Do a bitwise and on the keyboard state to check if the key is currently being pressed.
...
bool InputClass::IsF11Pressed()//Used in the system class to enable and disable fullscreen.
{
	// Do a bitwise and on the keyboard state to check if the f11 key is currently being pressed.
	if (m_keyboardState[DIK_F11] && 0x80)
	{
		return true;
	}
